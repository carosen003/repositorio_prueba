...
function arrastrarElemento(elementoDePlaza){
    let fin_X=0
        ...
        ori_X=0
        ori_Y=0
    elementoDePlaza.onpinterdown = arrastrarPuntero;
...
function arrastrarElemento(e){
    ...
    elementoDePlaza.style.top = elementoDePlaza.offsetTop - fin_Y + 'px';
    elementoDePlaza.style.left = elementoDePlaza.offsetLeft - fin_X + 'px';
}
